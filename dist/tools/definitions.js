...
const documentSourceProperties = {
    ...
    mime_type: {
        type: "string",
        description: "MIME type hint used for format auto-detection " +
    ...
    document_type: {
        ...
        default: "auto",
        description: 'Explicit document format. Use "auto" (default) to detect from mime_type or file extension.',
    },
};
// ---------------------------------------------------------------------------
// Tool definitions
...
exports.TOOL_DEFINITIONS = [
    {
        ...
        description: "Extract raw text content from a document. " +
    ...
    },
    {
        ...
        description: "Extract text from a document and summarize it with Claude AI. " +
    ...
    {
        name: "parse_fields",
        description: "Extract specific named fields from a document using Claude AI. " +
        ...
        inputSchema: {
            ...
            properties: {
                ...
                schema: {
                    ...
                    description: "Optional per-field descriptions that improve extraction accuracy, " +
    ...
    },
    {
        ...
        description: "Answer a specific question about a document using Claude AI. " +
            "Works with any supported format (PDF, DOCX, image, Excel, plain text). " +
            "You can also pass pre-extracted text directly via the `text` field.",
        inputSchema: {
            type: "object",
